 ...
 */
final class Version20241010162112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE certidao_divida_siatu (id INT NOT NULL, contribuinte_siatu_id INT NOT NULL, valor DOUBLE PRECISION NOT NULL, pdfdivida BYTEA DEFAULT NULL, descricao VARCHAR(255) DEFAULT NULL, data_vencimento DATE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_36C56A914D6ED255 ON certidao_divida_siatu (contribuinte_siatu_id)');
        $this->addSql('CREATE TABLE certidao_divida_supp (id INT NOT NULL, contribuinte_supp_id INT NOT NULL, valor DOUBLE PRECISION NOT NULL, pdfdivida BYTEA NOT NULL, descricao VARCHAR(255) DEFAULT NULL, data_vencimento DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_88C2AAE4B758B859 ON certidao_divida_supp (contribuinte_supp_id)');
        $this->addSql('CREATE TABLE contribuinte_siatu (id INT NOT NULL, nome VARCHAR(255) NOT NULL, cpf VARCHAR(255) NOT NULL, endereco VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
